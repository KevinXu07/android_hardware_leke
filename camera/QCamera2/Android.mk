...
# The stock L05 image ships the optional TutuSoft beauty libraries only as
# blobs.  Keep the source HAL independent from their missing build modules;
# this does not affect sensor bring-up, preview, capture, or flash control.
l05_camera_ts_makeup := $(TARGET_TS_MAKEUP)
ifeq ($(TARGET_DEVICE),L05)
l05_camera_ts_makeup := false
endif

ifeq ($(l05_camera_ts_makeup),true)
